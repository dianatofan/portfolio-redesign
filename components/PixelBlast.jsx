...
const PixelBlast = ({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const animate = () => {
        ...
        /*
         * Shader compile and link happen on this first render. The component is
         * loaded lazily now, so it arrives after the hero text has painted —
         * fade it in on the first real frame rather than letting it pop.
         */
  ...
  return (
    <div
      ...
      style={{ ...style, opacity: painted ? 1 : 0, transition: 'opacity 600ms ease-out' }}
