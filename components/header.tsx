...
import { PixelTransitionMenu } from "./pixel-transition-menu"
...
export function Header({ showBackButton = false }: { showBackButton?: boolean }) {
    ...
    return (
        <>
            <PixelTransitionMenu isOpen={open} onClose={() => setOpen(false)} />
            {!open && (
                ...
                "
                    >
                        ...
                        {/* ...existing code... */}
                        <nav className="hidden md:flex col-span-4 col-start-9 flex-col items-end gap-1">
                            <Link
                                href="/#work"
                        ...
                        {/* ...existing code... */}
                        <div className="md:hidden col-span-10 col-start-3 flex justify-end">
                            <button
                                onClick={() => setOpen(true)}
                                className="p-2 rounded hover:bg-[#f0f0f0] transition-colors duration-200"
